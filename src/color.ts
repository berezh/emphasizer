...
function emphasizeColorBase(fromValue: ColorProperty, toValue: ColorProperty, fromRate: number, toRate: number, rate: number): ColorProperty {
...
function emphasizeColor(fromValue: ColorProperty, toValue: ColorProperty, fromRate: number, toRate: number, rate: number): ColorProperty;
