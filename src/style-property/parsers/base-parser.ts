...
export abstract class BaseParser {
  ...
  public abstract emphasize(fromValue: StylePropertyType, toValue: StylePropertyType, fromRate: number, toRate: number, rate: number): string;
  ...
  protected emphasizeDimentionSet(from: DimentionOption[], to: DimentionOption[], fromRate: number, toRate: number, rate: number): string {
